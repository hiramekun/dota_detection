...
from dota_bbox_dataset import DotaBboxDataset
from dota_utils import place_labels
from util import resize_with_random_interpolation
...
def main(args):
    ...
    train = TransformDataset(
        DotaBboxDataset(split='train'),
        Transform(model.coder, model.insize, model.mean))
    train_iter = chainer.iterators.MultiprocessIterator(train, args.batchsize)

    test = DotaBboxDataset(split='test', use_difficult=True, return_difficult=True)
